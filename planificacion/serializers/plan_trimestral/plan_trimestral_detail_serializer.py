# planificacion/serializers/plan_trimestral/plan_trimestral_detail_serializer.py
from rest_framework import serializers

from planificacion.models.plan_trimestral_model import PlanTrimestral
from planificacion.serializers.item_plan_serializer import ItemPlanListSerializer
...
class PlanTrimestralDetailSerializer(serializers.ModelSerializer):
    ...
    def get_items(self, obj):
        qs = obj.items.select_related('competencia', 'docente__user').all()
        return ItemPlanListSerializer(qs, many=True).data